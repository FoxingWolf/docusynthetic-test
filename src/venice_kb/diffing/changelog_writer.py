...
from venice_kb.diffing.models import DiffReport, ChangeEntry, SeverityLevel
...
def render_changelog_markdown(reports: list[DiffReport]) -> str:
    ...
    for i, report in enumerate(reports):
        ...
        # Metadata
        prev_date = report.previous_snapshot.split("T")[0] if "T" in report.previous_snapshot else report.previous_snapshot
...
def _format_change_entry(change: ChangeEntry) -> str:
    ...
    """
    type_label = change.change_type.value.upper()
