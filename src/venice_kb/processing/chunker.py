...
from venice_kb.config import CHUNK_TARGET_TOKENS, CHUNK_MAX_TOKENS
...
def chunk_content(content: str, target_tokens: int | None = None, max_tokens: int | None = None) -> list[Chunk]:
